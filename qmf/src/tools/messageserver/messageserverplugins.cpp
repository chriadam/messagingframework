...
MessageServerPlugins::MessageServerPlugins(QObject *parent)
    : QObject(parent)
{
    init();
}

MessageServerPlugins::~MessageServerPlugins()
{
}

// Load and execute all plugins
void MessageServerPlugins::init()
{
