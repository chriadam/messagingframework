...
/*!
    ...
    \brief The QMailMessageServerPlugin class defines the interface to plugins that provide addon services
    for messageserver daemon.
    ...
    that need to know information about the operations initiated by all clients connected to messageserver.
...
/*!
    ...
    Executes the service provided by the plugin.
*/
